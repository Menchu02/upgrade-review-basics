...
//  silumar el codigo dentro de la función. Como hemos dicho, que la función use el parametro para simular una tirada de dado y retornar el resultado.
...
const rollDice = (param) => {
  let resultado = Math.floor(Math.random() * param + 1)
  return resultado
}
